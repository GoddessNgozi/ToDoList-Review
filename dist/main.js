...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_todolist_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/todolist.js */ \"./src/modules/todolist.js\");\n\n\n\nclass Todo {\n  constructor(description, completed, index) {\n    this.description = description;\n    this.completed = completed;\n    this.index = index;\n  }\n}\n\nwindow.onload = _modules_todolist_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].displayTodos();\ndocument.addEventListener('DOMContentLoaded', _modules_todolist_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].checkStatus);\n\nconst form = document.querySelector('.toDoForm');\nform.addEventListener('submit', (e) => {\n  e.preventDefault();\n  const description = document.querySelector('.description').value;\n  const todo = new Todo(description, false, _modules_todolist_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getTodos().length);\n  _modules_todolist_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].addTodo(todo);\n  _modules_todolist_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].displayTodos();\n  form.reset();\n});\n\nconst clear = document.querySelector('.clear-completed');\nclear.addEventListener('click', () => {\n  const checkers = document.querySelectorAll('.checker');\n  checkers.forEach((check) => {\n    if (check.id === 'true') {\n      check.parentElement.remove();\n    }\n  });\n  let todos = _modules_todolist_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getTodos();\n  todos = todos.filter((todo) => todo.completed !== true);\n  todos.forEach((todo, index) => {\n    todo.index = index;\n  });\n  localStorage.setItem('todos', JSON.stringify(todos));\n  _modules_todolist_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].emptyList();\n});\n\n\n//# sourceURL=webpack://todolist/./src/index.js?");
